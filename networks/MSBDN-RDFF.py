...
class Net(nn.Module):
    def __init__(self, res_blocks=18):
        ...
        self.conv_input = ConvLayer(4, 16, kernel_size=11, stride=1)
    ...
    def forward(self, x, m):
        ...
        res16x = F.interpolate(res16x, res8x.size()[2:], mode='bilinear', align_corners=False)
        ...
        res8x = F.interpolate(res8x, res4x.size()[2:], mode='bilinear', align_corners=False)
        ...
        res4x = F.interpolate(res4x, res2x.size()[2:], mode='bilinear', align_corners=False)
        ...
        res2x = F.interpolate(res2x, x.size()[2:], mode='bilinear', align_corners=False)
        x = torch.add(res2x, x)
